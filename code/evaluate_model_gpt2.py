...
if args.result_of_whitebox_model == "true":
    set_seed()
    whitebox_model = GPT2ForSequenceClassification.from_pretrained(args.weight_dir, num_labels=num_labels, use_safetensors=True)
...
if args.result_of_blackbox_model == "true":
    ...
    init_model = GPT2ForSequenceClassification.from_pretrained(args.model,num_labels=num_labels,use_safetensors=True)
...
if args.result_of_recover_model == "true":
    for obfus in ["soter", "tsqp", "translinkguard", "tempo", "shadownet"]:
        ...
        recover_model = GPT2ForSequenceClassification.from_pretrained(recover_dir, num_labels=num_labels,use_safetensors=True)
