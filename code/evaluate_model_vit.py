...
if args.result_of_whitebox_model == "true":
    set_seed()
    whitebox_model = timm.create_model("vit_base_patch16_224", pretrained=True, num_classes=num_classes)
...
if args.result_of_recover_model == "true":
    for obfus in ["soter", "tsqp", "translinkguard", "tempo", "shadownet"]:
        ...
        recover_model = timm.create_model("vit_base_patch16_224", pretrained=True, num_classes=num_classes)
