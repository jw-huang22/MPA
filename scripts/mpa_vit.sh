...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --recover_data_ratio) RECOVER_DATA_RATIO="$2"; shift ;;
        *) echo "Unknown parameter passed: $1"; exit 1 ;;
    esac
    shift
done

python code/mpa_vit.py \
    --gpus "$GPUS" \
    --dataset "$DATASET" \
    ...
    --recover_data_ratio "$RECOVER_DATA_RATIO"
